...
! Local variables
integer          iel
double precision utaurf
double precision, dimension(:), pointer ::cvar_visct

!===============================================================================
! Initialization of any quantity
!===============================================================================

!initialize global arrays and markcell 
call module_initialize(nfabor)
call adw_geom_init()
